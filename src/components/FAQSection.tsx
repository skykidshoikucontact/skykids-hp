...
const faqs = [
  ...
  {
    question: '送迎はありますか？',
    answer: '第二土曜日の出校日など、下校時にお迎えに行きます。詳しくはお問い合わせください。',
  },
  {
    question: '食事は出ますか？',
    answer: '出校日の第二土曜日以外の土曜日は、調理師による食事を提供しています。普段のおやつも手作りです。',
  },
  {
    question: '当日の利用は可能ですか？',
    answer: 'はい、一時預かりは当日受付も可能です。まずはお電話でご連絡ください。',
  },
  {
